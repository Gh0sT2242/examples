...
RegisterNetEvent('dri-admin:client:toggleNoclip')
AddEventHandler('dri-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            DRICore.Functions.Notify("Current speed: ".. speeds[travelSpeed])
